...
cc -g -Isrc -Isrc/third_party/protobuf/src -o apitest src/quux/apitest.c libquux.a -Lbuild -Lbuild/boringssl/crypto -Lbuild/protobuf -lquic -lcrypto -lprotobuf -lpthread -lstdc++ -lm
```
